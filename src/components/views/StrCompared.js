    ...
    constructor(props) {
        ...
        this.state = {
            ...
            rowData: [
                ...
                {section: "comments",
                    restriction: "Notes: Rhinebeck limits to 15 issued by lottery. Marbletown authorizes limits but none set in law or in a sechedule of fees",
                },
                ...
                {section: "comments",
                    restriction: "12 and under not considered guests, Marbletown ties occupancy capacity to septic which is based on bedrooms not number of people",
                },
                {restriction: "max occ based on septic*", woodstock:"N", woodstockCode:"",  marbletown:"Y", marbletownCode:"3-A-6", rhinebeck:"", rhinebeckCode:""},
                {section: "comments",
                    restriction: "no way to prove septic capacity in older buildings pre Dept of Health, no requirement that STR provide proof of septic",
                },
